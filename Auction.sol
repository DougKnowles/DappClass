...
// Data
   ...
   //Structure to hold the details of a persons
    ...
    modifier onlyOwner(address requestor) {
        require(requestor == beneficiary);
        _;
    }
    ...
    function register() public payable {
        ...
        /*Hint. Here the bidders[bidderCount].addr should be initialized with of the registrant.*/
        // ** Start code here. 1 line approximately. **/
        ...
        */
        for (uint id = 0; id < 3; id++) {
            ...
            if(currentItem.itemTokens.length != 0) {
                ...
                uint randomIndex = (block.number / currentItem.itemTokens.length)% currentItem.itemTokens.length; // Obtain the winning tokenId
